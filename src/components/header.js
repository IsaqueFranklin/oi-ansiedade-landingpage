...
function Header() {
    ...
    return (
        <Navbar collapseOnSelect expand="lg" variant="dark" sticky="top" style={{backgroundColor: "#010107", color: "#fff",}}>
            <Navbar.Brand style={{marginLeft: 20}} href="/"><img style={{height: '50px', width: '50px'}} src="img/logo2.png" alt="Quixote Club" /></Navbar.Brand>
            <Navbar.Toggle aria-controls="responsive-navbar-nav" />
            <Navbar.Collapse id="responsive-navbar-nav">
                <Nav className="mr-auto">
                    {/*<Nav.Link style={{marginLeft: 20}} href="/about">Sobre</Nav.Link>
                    <Nav.Link style={{marginLeft: 20, color: '#fff'}} href="/">Quixote Club</Nav.Link>*/}
